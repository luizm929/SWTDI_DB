...
def main():
    ...
    conn_string = "host='192.168.1.101' dbname='master_bedroom' user='worker101' password=powerproject"
    ...
    cursor.execute("INSERT INTO outlet1_2017_04 (Device_id, Voltage, Current, Phase, Temperature, Ocupancy, Power, Outlet1Timestamp, RPITimestamp, MainServerTimestamp)  VALUES (%s,%s, %s, %s, %s, %s, %s, %s, %s, %s)", ( "0x01", voltage, current, phase, temp, oc1, power,a,a,a))
    ...
    ########################################################################################################################    
    ## Smart Outlet 3
    st = "INSERT INTO outlet3_2017_04 (Device_id, Voltage, Current, Phase, Temperature,  Ocupancy, Power, Outlet1Timestamp, RPITimestamp, MainServerTimestamp) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)" 
    val = ("0x03", v3, c3, ph3, temp3, oc3, power3, a,a,a)
