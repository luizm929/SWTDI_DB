...
def main():
    ...
    #This returns true or false every time is called simulating opcupancy. 
    ...
    conn_string = "host='192.168.1.101' dbname='bedroom2' user='worker101' password=powerproject"
