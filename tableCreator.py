...
def main():
    ...
    conn_string = "host='192.168.1.101' dbname='masterdb' user='worker101' password=powerproject"
    ...
    ## Here we define types ans store values into table 
    cursor.execute("INSERT INTO outlet2_2017_04 (Device_id,Voltage,Current,Phase, Temperature, Ocupancy,Power,Outlet1Timestamp, RPITimestamp, MainServerTimestamp)  VALUES (%s, %s,%s, %s, %s,%s,%s,%s,%s,%s)", ("Ox02", v2, c2, ph2, temp2, '0', power2,a,a,a))
    ...
    cursor.execute("INSERT INTO outlet3_2017_04 (Device_id, Voltage, Current, Phase, Temperature, Ocupancy, Power, Outlet1Timestamp, RPITimestamp, MainServerTimestamp) VALUES (%s, %s, %s, %s, %s, %s,%s, %s, %s, %s)", ("0x03", v3, c3, ph3, temp3, '1', power3, a,a,a))
    
    ## Smart Outlet 4

    cursor.execute("CREATE TABLE IF NOT EXISTS outlet4_2017_04 (Device_id varchar) INHERITS (allsmartoutlets);")
    ## We insert the values in their columns
    cursor.execute("INSERT INTO outlet4_2017_04 (Device_id, Voltage, Current, Phase, Temperature, Ocupancy, Power, Outlet1Timestamp, RPITimestamp, MainServerTimestamp) VALUES (%s, %s, %s, %s, %s, %s,%s, %s, %s, %s)", ("0x04", v4, c4, ph4, temp4, '1', power4, a,a,a))
    ...
    """We insert the values in their columns"""
    cursor.execute("INSERT INTO outlet5_2017_04 (Device_id, Voltage, Current, Phase, Temperature, Ocupancy, Power, Outlet1Timestamp, RPITimestamp, MainServerTimestamp) VALUES (%s, %s, %s, %s, %s, %s,%s, %s, %s, %s)", ("0x05", v5, c5, ph5, temp5, '1', power5, a,a,a))
    ...
    ## We insert the values in their columns
    cursor.execute("INSERT INTO outlet6_2017_04 (Device_id, Voltage, Current, Phase, Temperature, Ocupancy, Power, Outlet1Timestamp, RPITimestamp, MainServerTimestamp) VALUES (%s, %s, %s, %s, %s, %s,%s, %s, %s, %s)", ("0x06", v6, c6, ph6, temp6, '1', power6, a,a,a))
